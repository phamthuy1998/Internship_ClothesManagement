package com.sg.snapshop.view.categories.adapter
...
import com.sg.snapshop.databinding.LayoutCountItemCategoryBinding
...
class CategoriesPagedAdapter(
    ...
    private val listenerAddProduct: ((product: Product?) -> Unit)? = null
