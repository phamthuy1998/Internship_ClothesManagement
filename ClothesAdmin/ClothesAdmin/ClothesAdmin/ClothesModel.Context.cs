...
namespace ClothesAdmin
{
    ...
    public partial class ClothesEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> forgotPasswordReset(string email, string newPass)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("forgotPasswordReset", emailParameter, newPassParameter);
        }
        ...
        public virtual int SP_GetProductSearchFilter(Nullable<int> typeId, string keySearch, Nullable<int> typeFilter, Nullable<int> categoryId, Nullable<int> currentPage, Nullable<int> pageSize, Nullable<int> accountID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GetProductSearchFilter", typeIdParameter, keySearchParameter, typeFilterParameter, categoryIdParameter, currentPageParameter, pageSizeParameter, accountIDParameter);
        }
        ...
        public virtual int SP_UpdateUser(Nullable<int> userId, string name, string email, string phone, Nullable<int> roleId, string password, string imageUrl)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_UpdateUser", userIdParameter, nameParameter, emailParameter, phoneParameter, roleIdParameter, passwordParameter, imageUrlParameter);
        }
        ...
        public virtual int SPGetAccounByUsername(string username)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("username", username) :
                new ObjectParameter("username", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SPGetAccounByUsername", usernameParameter);
        }
    
        public virtual int SPGetAccount(Nullable<int> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SPGetAccount", userIdParameter);
        }
