package com.n16dccn159.admin.view.categories
...
import com.n16dccn159.admin.databinding.FragmentCategoriesDetailBinding
...
import com.n16dccn159.admin.view.categories.adapter.CategoriesPagedAdapter
...
class CategoriesDetailFragment : BaseFragment<FragmentCategoriesDetailBinding>(),
    ...
    override fun bindViewModel() {
        ...
        viewModelProduct.productLoadStatusX.observe(this, Observer {
            ...
            when (it) {
                is com.n16dccn159.core.vo.Result.Error -> {
